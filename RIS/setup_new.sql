...
/*
 *  Grant privileges to group members
 */
GRANT ALL ON users TO qali;
GRANT ALL ON family_doctor TO qali;
GRANT ALL ON radiology_record TO qali;
GRANT ALL ON pacs_images TO qali;


GRANT ALL ON users TO jsurya;
GRANT ALL ON family_doctor TO jsurya;
GRANT ALL ON radiology_record TO jsurya;
GRANT ALL ON pacs_images TO jsurya;

/*
 *  to access tables:
 *    ALTER SESSION SET current_schema = <Member1>;
 */